...
$(function(){
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            { label: '位置', name: 'location', width: 80 },
            { label: '经度', name: 'longitude', width: 80 },
            { label: '纬度', name: 'latitude', width: 80 },
            { label: '所在路径编号', name: 'path', width: 80 },
            { label: '有效识别半径(m)', name: 'valid', width: 80 },
    ...
    $("#queryBtn").click(function(){
        ...
        var qryLocation=$("#qryLocation").val();
        //var qryEnd=$("#qryEnd").val();
        $(grid_selector).jqGrid('setGridParam',{
            postData:{name:qryName,location:qryLocation},
            //search: true,
            page:1
        }).trigger("reloadGrid");
    });
