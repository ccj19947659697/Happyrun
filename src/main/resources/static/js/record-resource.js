...
$(function(){
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            { label: '申诉日期', name: 'appealDate', width: 80 },
            { label: '申诉人学号', name: 'account', width: 80 },
            { label: '申诉的跑步日期', name: 'runDate', width: 80 },
            { label: '申诉的路径编号', name: 'pathId', width: 80 },
            { label: '申诉理由', name: 'reason', width: 300 },
